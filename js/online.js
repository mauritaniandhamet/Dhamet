...
const undonePath = (undoneMove && Array.isArray(undoneMove.path) && undoneMove.path.length)
  ...
  : (undoneMove && undoneMove.to != null ? [undoneMove.to] : null);
    ...
    initLobbyPage: async function(opts) {
      ...
      const lbBtn = document.getElementById("btnShowLeaderboardLobby");
      if (lbBtn) lbBtn.addEventListener("click", function(){ try{ if (window.ZLeaderboard && typeof ZLeaderboard.openModal === "function") ZLeaderboard.openModal(); }catch(_){} });
